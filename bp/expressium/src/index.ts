...
import { ApiKeyStrategy, BasicStrategy, BasicAndTokenStrategy, TokenStrategy } from './utils/strategies';
 ...
 */
const startServer = async (serverInstance: Server<typeof IncomingMessage, typeof ServerResponse> | any): Promise<Server<typeof IncomingMessage, typeof ServerResponse> | any> => {
  try {
