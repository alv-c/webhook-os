 ...
 * ### Response format:
 * 
 * - Success responses: `{ timestamp, status: true, statusCode, method, path, query, body, data: { ... }, ... }`
 * - Error responses: `{ timestamp, status: false, statusCode, method, path, query, body, message, suggestion, ... }`
 * 
 * ### Logging behavior:
 * 
